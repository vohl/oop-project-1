...
TEST(CollatzFixture, read_3) {
    string s("999999 999998\n");
    const pair<int, int> p = collatz_read(s);
    ASSERT_EQ(999999, p.first);
    ASSERT_EQ(999998, p.second);}
...
TEST(CollatzFixture, print_2) {
    ostringstream w;
    collatz_print(w, 1, 999999, 20);
    ASSERT_EQ("1 999999 20\n", w.str());}

TEST(CollatzFixture, print_3) {
    ostringstream w;
    collatz_print(w, 10, 999999, 1);
    ASSERT_EQ("10 999999 1\n", w.str());}

...
TEST(CollatzFixture, eval_a) {
    const int v = collatz_eval(1, 1);
    ASSERT_EQ(1, v);}

TEST(CollatzFixture, eval_b) {
    const int v = collatz_eval(10, 1);
    ASSERT_EQ(20, v);}

TEST(CollatzFixture, eval_c) {
...
TEST(CollatzFixture, print_a) {
    ostringstream w;
    collatz_print(w, 1, 2, 3);
    ASSERT_EQ("1 2 3\n", w.str());}

TEST(CollatzFixture, print_b) {
    ostringstream w;
    collatz_print(w, 1, 10, 100);
    ASSERT_EQ("1 10 100\n", w.str());}

TEST(CollatzFixture, print_c) {
    ostringstream w;
...
TEST(CollatzFixture, solve_a) {
    istringstream r("1 10\n100 200\n201 210\n");
    ostringstream w;
    collatz_solve(r, w);
    ASSERT_EQ("1 10 20\n100 200 125\n201 210 89\n", w.str());}

TEST(CollatzFixture, solve_b) {
    istringstream r("1 10\n100 200\n");
    ostringstream w;
    collatz_solve(r, w);
    ASSERT_EQ("1 10 20\n100 200 125\n", w.str());}

TEST(CollatzFixture, solve_c) {
    istringstream r("1 10\n");
    ostringstream w;
    collatz_solve(r, w);
    ASSERT_EQ("1 10 20\n", w.str());}

...
TEST(CollatzFixture, eval_single_2) {
    const int v = collatz_eval_single(33);
    ASSERT_EQ(27, v);
}

TEST(CollatzFixture, eval_single_3) {
...
TEST(CollatzFixture, solve_2) {
    istringstream r("854032 835912\n394958 374772\n");
    ostringstream w;
    collatz_solve(r, w);
    ASSERT_EQ("854032 835912 419\n394958 374772 436\n", w.str());
}

TEST(CollatzFixture, solve_3) {
    istringstream r("786636 768114\n236901 235018\n");
    ostringstream w;
    collatz_solve(r, w);
    ASSERT_EQ("786636 768114 437\n236901 235018 337\n", w.str());
}
